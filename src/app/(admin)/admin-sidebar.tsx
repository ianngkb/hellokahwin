...
/**
 * Desktop console sidebar (Monochrome Precision §5 AppShell) — a fixed 256px
 * rail (`w-64`, the width spec WI-1 calls for) on `--sidebar` with a hairline
 * right border, sticky to the viewport so
...
export function AdminSidebar({ badges }: { badges?: Record<string, number> }) {
  ...
  return (
    <aside className="bg-sidebar border-hairline sticky top-0 hidden h-screen w-64 shrink-0 flex-col overflow-y-auto border-r lg:flex">
